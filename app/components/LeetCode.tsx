...
function Ring({ solved, total, color, label, count }: {
              ...
              {[
                ...
                <div key={d.label}>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", marginBottom: "0.3rem" }}>
                    ...
                    <span style={{ color: "var(--muted)" }}>{loading ? "—" : `${d.solved} / ${d.total}`}</span>
                  </div>
                  <div style={{ height: "4px", background: "var(--surface-2)", borderRadius: "2px", overflow: "hidden" }}>
                    <div style={{
                      ...
                      background: d.color, borderRadius: "2px", transition: "width 1s ease",
                    }} />
                  </div>
                </div>
              ))}
